...
class RpcHeader : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mprpc.RpcHeader)
                                                           */
{
  public:
    RpcHeader();
...
inline void RpcHeader::set_allocated_service_name(std::string *service_name) {
    ...
    service_name_.SetAllocatedNoArena(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        service_name);
...
inline void RpcHeader::set_allocated_method_name(std::string *method_name) {
    ...
    method_name_.SetAllocatedNoArena(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        method_name);
...
inline void
RpcHeader::_internal_set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
