...
static ::PROTOBUF_NAMESPACE_ID::Message const *const file_default_instances[] =
    {
        ...
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message *>(
            &::fixbug::_RegisterResponse_default_instance_),
};
    ...
    while (!ctx->Done(&ptr)) {
        ...
        case 2:
            if (PROTOBUF_PREDICT_TRUE(
                ...
                ptr =
                    ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
                        str, ptr, ctx);
                CHK_(ptr);
            } else
                goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8 *ResultCode::_InternalSerialize(
    ...
    if (this->errcode() != 0) {
        ...
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
            WriteInt32ToArray(1, this->_internal_errcode(), target);
    }
...
::PROTOBUF_NAMESPACE_ID::uint8 *LoginRequest::_InternalSerialize(
    ...
    if (this->name().size() > 0) {
        target =
            stream->WriteBytesMaybeAliased(1, this->_internal_name(), target);
    }

    // bytes pwd = 2;
    if (this->pwd().size() > 0) {
        target =
            stream->WriteBytesMaybeAliased(2, this->_internal_pwd(), target);
    }
...
void LoginResponse::InitAsDefaultInstance() {
    ::fixbug::_LoginResponse_default_instance_._instance.get_mutable()
...
::PROTOBUF_NAMESPACE_ID::uint8 *LoginResponse::_InternalSerialize(
    ...
    if (this->has_result()) {
        target = stream->EnsureSpace(target);
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
            InternalWriteMessage(1, _Internal::result(this), target, stream);
    }
...
::PROTOBUF_NAMESPACE_ID::uint8 *RegisterRequest::_InternalSerialize(
    ...
    if (this->id() != 0) {
        target = stream->EnsureSpace(target);
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
            WriteUInt32ToArray(1, this->_internal_id(), target);
    }

    // bytes name = 2;
    if (this->name().size() > 0) {
        target =
            stream->WriteBytesMaybeAliased(2, this->_internal_name(), target);
    }

    // bytes pwd = 3;
    if (this->pwd().size() > 0) {
        target =
            stream->WriteBytesMaybeAliased(3, this->_internal_pwd(), target);
    }
...
void RegisterResponse::InitAsDefaultInstance() {
    ::fixbug::_RegisterResponse_default_instance_._instance.get_mutable()
        ->result_ = const_cast<::fixbug::ResultCode *>(
        ::fixbug::ResultCode::internal_default_instance());
}
...
void UserServiceRpc::Register(
    ...
    const ::fixbug::RegisterRequest *, ::fixbug::RegisterResponse *,
    ::google::protobuf::Closure *done) {
...
void UserServiceRpc_Stub::Login(
    ::PROTOBUF_NAMESPACE_ID::RpcController *controller,
    const ::fixbug::LoginRequest *request, ::fixbug::LoginResponse *response,
    ::google::protobuf::Closure *done) {
